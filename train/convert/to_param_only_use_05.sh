...
export TPU_PREFIX=taiming-v4-128_000052
...
for checkpoint in 24999; do
    ...
    python -u multihost_runner_orig.py \
        ...
        python3.10 -u -m MaxText.generate_param_only_checkpoint MaxText/configs/base.yml \
          load_full_state_path=gs://taiming_us_central2_b/ckpts/pretrain/llama3.1-05b-finewebedu-vanilla-s42/checkpoints/$checkpoint/items \
          checkpoint_dir=gs://taiming_us_central2_b/ckpts/pretrain_param_only/llama3.1-05b-finewebedu-vanilla-s42/checkpoint_$checkpoint \
