...
export RUN_NAME="exp1_llama3.1-1b-A3BT50BS42-a1-s43-t0"
export RUN_ID="exp1_llama1b_finewebedu_distill_soft_A3BT50BS42_a1_s43-t0"

# Distillation parameters

echo "========================"
echo "running exp1_llama1b-A3BT50BS42-a1-s43-t0.sh"
echo "parameters:"
