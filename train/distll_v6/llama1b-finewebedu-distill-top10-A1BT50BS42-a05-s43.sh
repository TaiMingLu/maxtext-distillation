...
export RUN_NAME="${MODEL_NAME}-finewebedu-distill-top10-A1BT50BS42-a05-s43_v6"
export RUN_ID="llama1b_finewebedu_distill_top10_A1BT50BS42_a05_s43_v6"

# Distillation parameters

echo "========================"
echo "running llama1b-finewebedu-distill-top10-A1BT50BS42-a05-s43.sh"
echo "parameters:"
