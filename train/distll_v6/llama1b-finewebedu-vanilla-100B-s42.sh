...
export RUN_NAME="${MODEL_NAME}-finewebedu-vanilla-100B-s42_v6"
export RUN_ID="llama1b_finewebedu_vanilla_100B_s42_v6"

echo "========================"
echo "running llama1b-finewebedu-vanilla-100B-s42.sh"
echo "parameters:"
