...
export RUN_NAME="${MODEL_NAME}-finewebedu-distill-soft-A05BT50BS42-a04-s43_v6"
export RUN_ID="llama1b_finewebedu_distill_soft_A05BT50BS42_a04_s43_v6"

# Distillation parameters

echo "========================"
echo "running llama1b-finewebedu-distill-soft-A05BT50BS42-a04-s43_v6.sh"
echo "parameters:"
