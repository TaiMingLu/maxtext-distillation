...
export RUN_NAME="${MODEL_NAME}-finewebedu-distill-top10000-A05BT50BS42-a1-s43_v6"
export RUN_ID="llama1b_finewebedu_distill_top10000_A05BT50BS42_a1_s43_v6"

# Distillation parameters

echo "========================"
echo "running llama1b-finewebedu-distill-top10000-A05BT50BS42-a1-s43.sh"
echo "parameters:"
