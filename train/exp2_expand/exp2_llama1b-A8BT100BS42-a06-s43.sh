...
export RUN_NAME="exp2_llama3.1-1b-A8BT100BS42-a06-s43"
export RUN_ID="exp2_llama1b_finewebedu_distill_soft_A8BT100BS42_a06_s43"

# Distillation parameters

echo "========================"
echo "running exp2_llama1b-A8BT100BS42-a06-s43.sh"
echo "parameters:"
