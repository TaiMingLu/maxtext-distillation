...
export RUN_NAME="exp2_llama3.1-1b-A8BT10BS42-a08-s43"
export RUN_ID="exp2_llama1b_finewebedu_distill_soft_A8BT10BS42_a08_s43"

# Distillation parameters

echo "========================"
echo "running exp2_llama1b-A8BT10BS42-a08-s43.sh"
echo "parameters:"
