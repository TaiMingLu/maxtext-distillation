...
export RUN_NAME="exp2_llama3.1-1b-A1BT50BS42-a06-s43"
export RUN_ID="exp2_llama1b_finewebedu_distill_soft_A1BT50BS42_a06_s43"

# Distillation parameters

echo "========================"
echo "running exp2_llama1b-A1BT50BS42-a06-s43.sh"
echo "parameters:"
