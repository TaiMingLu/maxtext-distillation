...
export RUN_NAME="exp2_llama3.1-1b-A8BT30BS42-a02-s43"
export RUN_ID="exp2_llama1b_finewebedu_distill_soft_A8BT30BS42_a02_s43"

# Distillation parameters

echo "========================"
echo "running exp2_llama1b-A8BT30BS42-a02-s43.sh"
echo "parameters:"
