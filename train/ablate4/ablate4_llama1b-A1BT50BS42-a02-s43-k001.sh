...
export KD_TOP_K=1283

export RUN_NAME="exp1_llama3.1-1b-A1BT50BS42-a02-s43-k001"
export RUN_ID="exp1_llama1b_finewebedu_distill_soft_A1BT50BS42_a02_s43_k001"

# Distillation parameters

echo "========================"
echo "running exp1_llama1b-A1BT50BS42-a02-s43-k001.sh"
echo "parameters:"
