...
export BASE_OUTPUT_DIRECTORY="gs://$BUCKET_NAME/ckpts/ablate4"
export DATA_FILES='/home/terry/gcs-data/datasets/fineweb-edu/*.array_record'
export KD_TOP_K=6413

export RUN_NAME="exp1_llama3.1-1b-A1BT50BS42-a02-s43-k005"
export RUN_ID="exp1_llama1b_finewebedu_distill_soft_A1BT50BS42_a02_s43_k005"

# Distillation parameters

echo "========================"
echo "running exp1_llama1b-A1BT50BS42-a02-s43-k005.sh"
echo "parameters:"
