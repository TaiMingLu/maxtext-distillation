...
export RUN_NAME="${MODEL_NAME}-finewebedu-vanilla-s43-100b"
export RUN_ID="llama1b_finewebedu_vanilla_s43_100b"

echo "========================"
echo "running llama1b-finewebedu-vanilla-s43-100b.sh"
echo "parameters:"
