...
export RUN_NAME="${MODEL_NAME}-finewebedu-vanilla-s42-100b"
export RUN_ID="llama8b_finewebedu_vanilla_s42_100b"

echo "========================"
echo "running llama8b-finewebedu-vanilla-s42.sh-100b"
echo "parameters:"
