...
export RUN_NAME="${MODEL_NAME}-finewebedu-vanilla-s42-30b"
export RUN_ID="llama8b_finewebedu_vanilla_s42_30b"

echo "========================"
echo "running llama8b-finewebedu-vanilla-s42.sh-30b"
echo "parameters:"
