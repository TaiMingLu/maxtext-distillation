...
export RUN_NAME="${MODEL_NAME}-finewebedu-vanilla-s42-double-machine-half-batch"
export RUN_ID="llama05b_finewebedu_vanilla_s42_double_machine_half_batch"

echo "========================"
echo "running llama05b-finewebedu-vanilla-s42-double-machine-half-batch.sh"
echo "parameters:"
