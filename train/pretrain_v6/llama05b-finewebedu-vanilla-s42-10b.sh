...
export RUN_NAME="${MODEL_NAME}-finewebedu-vanilla-s42-10b"
export RUN_ID="llama05b_finewebedu_vanilla_s42_10b"

echo "========================"
echo "running llama05b-finewebedu-vanilla-s42-10b.sh"
echo "parameters:"
