...
export RUN_NAME="${MODEL_NAME}-finewebedu-vanilla-s42-80b"
export RUN_ID="llama05b_finewebedu_vanilla_s42_80b"

echo "========================"
echo "running llama05b-finewebedu-vanilla-s42-80b.sh"
echo "parameters:"
