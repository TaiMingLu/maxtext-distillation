...
export JAX_LOCAL_DEVICE_COUNT=32
...
ENGINE_PARALLEL_FLAGS=(ici_data_parallelism=4 ici_tensor_parallelism=4 ici_fsdp_parallelism=2 ici_autoregressive_parallelism=1)
# Product: 4 × 4 × 2 × 1 = 32 (for v6e-32)
