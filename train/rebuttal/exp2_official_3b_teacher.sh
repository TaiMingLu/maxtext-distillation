#!/bin/bash
# Exp 2 (revised): Pure KD with official Llama 3.2 3B teacher
# Student: 1.7B, 50B tokens, pure KD (alpha=1.0)
# Teacher: official Llama 3.2 3B (3072 emb, 24 heads, head_dim=128)

cd ~/maxtext

echo "========================"
echo "Exp 2: Official 3B teacher, pure KD"
...
export TEACHER_MODEL_NAME='llama3.2-3b-official'
export KD_TEACHER_PARAMETERS_PATH="/home/terry/gcs-bucket/rebuttal/converted/llama3.2-3b-official/0/items"

export BASE_OUTPUT_DIRECTORY="gs://$BUCKET_NAME/rebuttal/exp2"
export DATA_FILES='/home/terry/gcs-bucket/rebuttal/data/fineweb-edu/*.array_record'
export RUN_NAME="exp2_official-3b-teacher_a1-s43"
export RUN_ID="exp2_official_3b_teacher_a1_s43"
