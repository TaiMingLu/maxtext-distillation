...
export RUN_NAME="${MODEL_NAME}-finewebedu-distill-soft-T50BS42-a1-s43"
export RUN_ID="llama1b_finewebedu_distill_soft_T50BS42_a1_s43"

# Distillation parameters

echo "========================"
echo "running llama1b-finewebedu-distill-soft-T50BS42-a1-s43.sh"
echo "parameters:"
