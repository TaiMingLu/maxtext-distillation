...
export RUN_NAME="${MODEL_NAME}_finewebedu_distill_hard_pretrain_A_1B_T_25B_S42_alpha_06_seed43"
export RUN_ID="llama3-1b_finewebedu_distill_hard_pretrain_A_1B_T_25B_S42_alpha_06_seed43"

# Distillation parameters

echo "========================"
echo "running llama3_1b_fineweb_distill_hard_pretrain_A_1B_T_25B_S42_seed43.sh"
echo "parameters:"
