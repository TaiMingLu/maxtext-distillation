...
export PRETRAINED_CHECKPOINT="gs://${BUCKET_NAME}/ckpts/vanilla/llama3.1-1b-finewebedu-vanilla-s43-50b/checkpoints/24999/items"
# Output directory for SFT checkpoints
export BASE_OUTPUT_DIRECTORY="gs://$BUCKET_NAME/ckpts/sft_debug"

# Run naming
export RUN_NAME="sft_t5_vanilla1b_b2_s4000_5e-6_cos"
export RUN_ID="sft_t5_vanilla1b_b2_s4000_5e-6_cos"
