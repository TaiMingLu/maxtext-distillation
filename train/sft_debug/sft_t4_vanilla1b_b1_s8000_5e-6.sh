...
# Recipe: constant
#   - Warmup: 0.1
#   - LR decay: 1.0 (1.0 = constant, <1.0 = cosine decay)
#
...
export NUM_STEPS=8000
export LR=5e-6
export MIN_LR_RATIO=1.0  # 1.0 = constant, <1.0 = cosine decay
...
# Run naming
export RUN_NAME="sft_t4_vanilla1b_b1_s8000_5e-6"
export RUN_ID="sft_t4_vanilla1b_b1_s8000_5e-6"
