...
export RUN_NAME="exp1-100b_llama3.1-1b-A8BT100BS42-a02-s43"
export RUN_ID="exp1_100b_llama1b_finewebedu_distill_soft_A8BT100BS42_a02_s43"

# Distillation parameters

echo "========================"
echo "running exp1-100b_llama1b-A8BT100BS42-a02-s43.sh"
echo "parameters:"
