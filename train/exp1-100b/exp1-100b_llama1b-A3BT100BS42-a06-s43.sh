...
export USE_KD=true
export KD_ALPHA=0.6  #KD_ALPHA=0.0 -- pure cross-entropy (no KD), KD_ALPHA=1.0 -- makes purely the KD term
export KD_TEMPERATURE=1.0
export KD_TEACHER_PARAMETERS_PATH="/home/terry/gcs-bucket/ckpts/pretrain_param_only_v6/llama3b-vanilla-100B-s42/checkpoint_49999/0/items"
...
export RUN_NAME="exp1-100b_llama3.1-1b-A3BT100BS42-a06-s43"
export RUN_ID="exp1_100b_llama1b_finewebedu_distill_soft_A3BT100BS42_a06_s43"

# Distillation parameters

echo "========================"
echo "running exp1-100b_llama1b-A3BT100BS42-a06-s43.sh"
echo "parameters:"
