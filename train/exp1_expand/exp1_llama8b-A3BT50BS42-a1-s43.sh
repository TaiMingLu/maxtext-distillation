...
export RUN_NAME="exp1_llama3.1-8b-A3BT50BS42-a1-s43"
export RUN_ID="exp1_llama8b_finewebedu_distill_soft_A3BT50BS42_a1_s43"

# Distillation parameters

echo "========================"
echo "running exp1_llama8b-A3BT50BS42-a1-s43.sh"
echo "parameters:"
