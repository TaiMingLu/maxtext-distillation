...
export RUN_NAME="exp1_llama3.1-3b-A1BT50BS42-a06-s43"
export RUN_ID="exp1_llama3b_finewebedu_distill_soft_A1BT50BS42_a06_s43"

# Distillation parameters

echo "========================"
echo "running exp1_llama3b-A1BT50BS42-a06-s43.sh"
echo "parameters:"
