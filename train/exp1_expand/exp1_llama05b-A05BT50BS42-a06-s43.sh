...
export RUN_NAME="exp1_llama3.1-05b-A05BT50BS42-a06-s43"
export RUN_ID="exp1_llama05b_finewebedu_distill_soft_A05BT50BS42_a06_s43"

# Distillation parameters

echo "========================"
echo "running exp1_llama05b-A05BT50BS42-a06-s43.sh"
echo "parameters:"
