...
export RUN_NAME="exp1_llama3.1-1b-A05BT50BS42-a05-s43"
export RUN_ID="exp1_llama1b_finewebedu_distill_soft_A05BT50BS42_a05_s43"

# Distillation parameters

echo "========================"
echo "running exp1_llama1b-A05BT50BS42-a05-s43.sh"
echo "parameters:"
