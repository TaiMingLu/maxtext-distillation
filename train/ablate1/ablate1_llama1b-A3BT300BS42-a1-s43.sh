...
export RUN_NAME="ablate1_llama3.1-1b-A3BT300BS42-a1-s43"
export RUN_ID="ablate1_llama1b_finewebedu_distill_soft_A3BT300BS42_a1_s43"

# Distillation parameters

echo "========================"
echo "running ablate1_llama1b-A3BT300BS42-a1-s43.sh"
echo "parameters:"
