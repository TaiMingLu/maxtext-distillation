...
export KD_TEACHER_PARAMETERS_PATH="/home/terry/gcs-bucket/ckpts/pretrain_param_only/llama3b-vanilla-50B-s42/checkpoint_24999/0/items"
...
export RUN_NAME="exp2_${MODEL_NAME}-A3BT50BS42-a05-s43"
export RUN_ID="exp2_llama1b_finewebedu_distill_soft_A3BT50BS42_a04_s43"

# Distillation parameters

echo "========================"
echo "running llama1b-finewebedu-distill-soft-A3BT50BS42-a04-s43.sh"
echo "parameters:"
