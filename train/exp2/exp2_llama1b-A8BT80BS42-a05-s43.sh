...
export RUN_NAME="exp2_llama3.1-1b-A8BT80BS42-a05-s43"
export RUN_ID="exp2_llama1b_finewebedu_distill_soft_A8BT80BS42_a05_s43"

# Distillation parameters

echo "========================"
echo "running exp2_llama1b-A8BT80BS42-a05-s43.sh"
echo "parameters:"
