...
export KD_TEACHER_PARAMETERS_PATH="/home/terry/gcs-bucket/ckpts/pretrain_param_only/llama3.1-1b-commoncrawl_pretrain_shuffled_lr_3e-4_seed_42/checkpoint_24999/0/items"
...
export RUN_NAME="${MODEL_NAME}_commoncrawl_distill_pretrain_A_1B_T_50B_S42_alpha_05_seed43"
export RUN_ID="llama3-1b_commoncrawl_distill_pretrain_A_1B_T_50B_S42_alpha_05_seed43"

# Distillation parameters

echo "========================"
echo "running llama3_1b_commoncrawl_distill_pretrain_A_1B_T_50B_S42_seed43.sh"
echo "parameters:"
