...
export RUN_NAME="${MODEL_NAME}_commoncrawl_distill_pretrain_A_1B_T_50B_S42_alpha_1_seed43"
export RUN_ID="llama3-1b_commoncrawl_distill_pretrain_A_1B_T_50B_S42_alpha_1_seed43"
