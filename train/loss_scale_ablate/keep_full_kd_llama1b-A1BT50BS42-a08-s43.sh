...
export USE_KD=true
export KD_ALPHA=0.8  #KD_ALPHA=0.0 -- pure cross-entropy (no KD), KD_ALPHA=1.0 -- makes purely the KD term
export KD_TEMPERATURE=1.0
export KD_TEACHER_PARAMETERS_PATH="/home/terry/gcs-bucket/ckpts/pretrain_param_only_v6/llama1b-vanilla-50B-s42/checkpoint_24999/0/items"
...
export RUN_NAME="keep_full_kd_llama3.1-1b-A1BT50BS42-a08-s43"
export RUN_ID="keep_full_kd_llama1b_finewebedu_distill_soft_A1BT50BS42_a08_s43"

# Distillation parameters

echo "========================"
echo "running keep_full_kd_llama1b-A1BT50BS42-a08-s43.sh"
echo "parameters:"
