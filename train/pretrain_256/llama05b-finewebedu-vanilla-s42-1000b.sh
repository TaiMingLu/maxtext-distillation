...
export RUN_NAME="${MODEL_NAME}-finewebedu-vanilla-s42-1000b-256"
export RUN_ID="llama05b_finewebedu_vanilla_s42_1000b-256"

echo "========================"
echo "running llama05b-finewebedu-vanilla-s42-1000b.sh"
echo "parameters:"
