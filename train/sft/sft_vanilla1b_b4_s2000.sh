...
export SEQ_LEN=4096
export BATCH_SIZE=4  # per-device batch size; on v6e-32 (32 chips): 8 * 32 * 4096 = ~1M tokens/step
export GRAD_ACCUM=1

# SFT training hyperparameters (typically lower LR than pretraining)
export NUM_STEPS=2000  # ~1B tokens total (1M tokens/step * 1000 steps)
export LR=1.e-5
...
# Run naming
export RUN_NAME="sft_vanilla1b_b4_s2000"
export RUN_ID="sft_vanilla1b_b4_s2000"
