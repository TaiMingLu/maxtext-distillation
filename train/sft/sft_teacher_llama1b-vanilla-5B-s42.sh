...
export PRETRAINED_CHECKPOINT="gs://${BUCKET_NAME}/ckpts_copy/pretrain_param_only_v6/llama1b-vanilla-5B-s42/checkpoint_2499/0/items"
# Output directory for SFT checkpoints
export BASE_OUTPUT_DIRECTORY="gs://$BUCKET_NAME/ckpts/sft"

# Run naming
export RUN_NAME="sft_llama1b-vanilla-5B-s42"
export RUN_ID="sft_teacher_llama1b_vanilla_5B_s42"
