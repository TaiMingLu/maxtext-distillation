...
# Loads pretrained checkpoint and fine-tunes on HuggingFace conversational dataset
#
# Example: Fine-tune the distilled Llama 1B model on UltraChat dataset
#
...
# Update this path to point to your actual checkpoint
export PRETRAINED_CHECKPOINT="gs://${BUCKET_NAME}/ckpts/distill_pretrain/exp2_llama3.1-1b-A1BT100BS42-a1-s43/checkpoints/24999/items"
# Output directory for SFT checkpoints
export BASE_OUTPUT_DIRECTORY="gs://$BUCKET_NAME/ckpts/sft"

# Run naming
export RUN_NAME="sft_exp2_llama3.1-1b-A1BT100BS42-a1-s43"
export RUN_ID="sft_exp2_llama3.1_1b_A1BT100BS42_a1_s43"
...
# wandb login --relogin YOUR_WANDB_KEY
