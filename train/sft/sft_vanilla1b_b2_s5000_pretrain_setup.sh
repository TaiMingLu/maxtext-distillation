...
export NUM_STEPS=5000  # ~1B tokens total (1M tokens/step * 1000 steps)
export LR=3.e-4
...
# Run naming
export RUN_NAME="sft_vanilla1b_b2_s5000_pretrain_setup"
export RUN_ID="sft_vanilla1b_b2_s5000_pretrain_setup"
