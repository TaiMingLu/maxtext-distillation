...
export PRETRAINED_CHECKPOINT="gs://${BUCKET_NAME}/ckpts_copy/pretrain_param_only_v6/llama3b-vanilla-10B-s42/checkpoint_4999/0/items"
# Output directory for SFT checkpoints
export BASE_OUTPUT_DIRECTORY="gs://$BUCKET_NAME/ckpts/sft"

# Run naming
export RUN_NAME="sft_llama3b-vanilla-10B-s42"
export RUN_ID="sft_teacher_llama3b_vanilla_10B_s42"
