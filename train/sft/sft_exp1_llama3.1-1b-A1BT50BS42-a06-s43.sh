...
export PRETRAINED_CHECKPOINT="gs://${BUCKET_NAME}/ckpts/distill_pretrain/exp1_llama3.1-1b-A1BT50BS42-a06-s43/checkpoints/24999/items"
# Output directory for SFT checkpoints
export BASE_OUTPUT_DIRECTORY="gs://$BUCKET_NAME/ckpts/sft"

# Run naming
export RUN_NAME="sft_exp1_llama3.1-1b-A1BT50BS42-a06-s43"
export RUN_ID="sft_exp1_llama3.1_1b_A1BT50BS42_a06_s43"
