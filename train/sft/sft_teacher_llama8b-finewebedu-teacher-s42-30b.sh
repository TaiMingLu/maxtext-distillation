...
export PRETRAINED_CHECKPOINT="gs://${BUCKET_NAME}/ckpts/pretrain/llama8b-finewebedu-teacher-s42-30b/checkpoints/14999/items"
# Output directory for SFT checkpoints
export BASE_OUTPUT_DIRECTORY="gs://$BUCKET_NAME/ckpts/sft"

# Run naming
export RUN_NAME="sft_llama8b-finewebedu-teacher-s42-30b"
export RUN_ID="sft_teacher_llama8b_finewebedu_teacher_s42_30b"
