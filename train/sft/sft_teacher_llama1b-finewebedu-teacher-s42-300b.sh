...
export PRETRAINED_CHECKPOINT="gs://${BUCKET_NAME}/ckpts/pretrain/llama1b-finewebedu-teacher-s42-300b/checkpoints/149999/items"
# Output directory for SFT checkpoints
export BASE_OUTPUT_DIRECTORY="gs://$BUCKET_NAME/ckpts/sft"

# Run naming
export RUN_NAME="sft_llama1b-finewebedu-teacher-s42-300b"
export RUN_ID="sft_teacher_llama1b_finewebedu_teacher_s42_300b"
