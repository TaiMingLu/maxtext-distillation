...
export PRETRAINED_CHECKPOINT="gs://${BUCKET_NAME}/ckpts_copy/pretrain_param_only_v6/llama8b-vanilla-100B-s42/checkpoint_49999/0/items"
# Output directory for SFT checkpoints
export BASE_OUTPUT_DIRECTORY="gs://$BUCKET_NAME/ckpts/sft"

# Run naming
export RUN_NAME="sft_llama8b-vanilla-100B-s42"
export RUN_ID="sft_teacher_llama8b_vanilla_100B_s42"
