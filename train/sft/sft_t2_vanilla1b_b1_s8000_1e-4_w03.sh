...
export SEQ_LEN=4096
export BATCH_SIZE=1  # per-device batch size; on v6e-32 (32 chips): 8 * 32 * 4096 = ~1M tokens/step
export GRAD_ACCUM=1

# SFT training hyperparameters (typically lower LR than pretraining)
export NUM_STEPS=8000  # ~1B tokens total (1M tokens/step * 1000 steps)
export LR=1.e-4
export MIN_LR_RATIO=1.0  # Constant LR (no decay)
export WARMUP_RATIO=0.3
...
# Run naming
export RUN_NAME="sft_t2_vanilla1b_b1_s8000_1e-4_w03"
export RUN_ID="sft_t2_vanilla1b_b1_s8000_1e-4_w03"
