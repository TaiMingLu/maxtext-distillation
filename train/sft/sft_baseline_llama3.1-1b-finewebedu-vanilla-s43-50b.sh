...
export PRETRAINED_CHECKPOINT="gs://${BUCKET_NAME}/ckpts_copy/vanilla/llama3.1-1b-finewebedu-vanilla-s43-50b/checkpoints/24999/items"
# Output directory for SFT checkpoints
export BASE_OUTPUT_DIRECTORY="gs://$BUCKET_NAME/ckpts/sft"

# Run naming
export RUN_NAME="sft_llama3.1-1b-finewebedu-vanilla-s43-50b"
export RUN_ID="sft_baseline_llama3_1_1b_finewebedu_vanilla_s43_50b"
