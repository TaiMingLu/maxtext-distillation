...
export PRETRAINED_CHECKPOINT="gs://${BUCKET_NAME}/ckpts_copy/pretrain_param_only_v6/llama1b-vanilla-80B-s42/checkpoint_39999/0/items"
# Output directory for SFT checkpoints
export BASE_OUTPUT_DIRECTORY="gs://$BUCKET_NAME/ckpts/sft"

# Run naming
export RUN_NAME="sft_llama1b-vanilla-80B-s42"
export RUN_ID="sft_teacher_llama1b_vanilla_80B_s42"
