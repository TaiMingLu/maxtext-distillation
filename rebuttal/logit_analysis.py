...
MODELS = {
    ...
    "distilled_A05B_a02": {
        "ckpt": f"{BUCKET_PREFIX}/distilled/A05B-a02/24999/items/0/items",
        "model_name": "llama3.1-1b",
        "role": "distilled",
        "teacher": "teacher_05b",
        "alpha": 0.2,
    ...
    "distilled_A1B_a04": {
        "ckpt": f"{BUCKET_PREFIX}/distilled/A1B-a04/24999/items/0/items",
        "model_name": "llama3.1-1b",
        "role": "distilled",
        "teacher": "teacher_1b",
        "alpha": 0.4,
    ...
    "distilled_A3B_a06": {
        "ckpt": f"{BUCKET_PREFIX}/distilled/A3B-a06/24999/items/0/items",
        "model_name": "llama3.1-1b",
        "role": "distilled",
        "teacher": "teacher_3b",
        "alpha": 0.6,
    ...
    "distilled_A8B_a06": {
        "ckpt": f"{BUCKET_PREFIX}/distilled/A8B-a06/24999/items/0/items",
        "model_name": "llama3.1-1b",
        "role": "distilled",
        "teacher": "teacher_8b",
        "alpha": 0.6,
    ...
    "distilled_A05B_a1": {
        "ckpt": f"{BUCKET_PREFIX}/distilled/A05B-a1/24999/items/0/items",
        "model_name": "llama3.1-1b",
        "role": "distilled",
        "teacher": "teacher_05b",
        "alpha": 1.0,
    ...
    "distilled_A1B_a1": {
        "ckpt": f"{BUCKET_PREFIX}/distilled/A1B-a1/24999/items/0/items",
        "model_name": "llama3.1-1b",
        "role": "distilled",
        "teacher": "teacher_1b",
        "alpha": 1.0,
    ...
    "distilled_A3B_a1": {
        "ckpt": f"{BUCKET_PREFIX}/distilled/A3B-a1/24999/items/0/items",
        "model_name": "llama3.1-1b",
        "role": "distilled",
        "teacher": "teacher_3b",
        "alpha": 1.0,
    ...
    "distilled_A8B_a1": {
        "ckpt": f"{BUCKET_PREFIX}/distilled/A8B-a1/24999/items/0/items",
        "model_name": "llama3.1-1b",
        "role": "distilled",
        "teacher": "teacher_8b",
        "alpha": 1.0,
